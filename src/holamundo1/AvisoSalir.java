 ...
 * @author alumno_n
 */
public class AvisoSalir extends javax.swing.JDialog {

    /**
     * Creates new form AvisoSalir
     */
    public AvisoSalir(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(300, 300);
        this.setResizable(false);
        this.setTitle("Confrimacion de Salida");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Esá seguro que desea salir?");
        ...
        btn_no.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btn_no.setText("NO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvisoSalir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AvisoSalir dialog = new AvisoSalir(new javax.swing.JFrame(), true);
